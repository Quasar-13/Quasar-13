...
/datum/job/tegu/deputy
	...
	id_icon = 'ModularBungalow/legacy_icons/cards.dmi'
	hud_icon = 'ModularBungalow/legacy_icons/teguhud.dmi'
...
/obj/item/clothing/under/rank/security/mallcop
	...
	worn_icon = 'ModularBungalow/legacy_icons/mith_stash/clothing/under_worn.dmi' //will be sharing a DMI with digisuits
	icon = 'ModularBungalow/legacy_icons/mith_stash/clothing/under_icons.dmi'
	icon_state = "mallcop"
	strip_delay = 50
...
/obj/item/clothing/head/beret/sec/engineering
	...
	worn_icon = 'ModularBungalow/legacy_icons/mith_stash/clothing/head_worn.dmi'
	icon = 'ModularBungalow/legacy_icons/mith_stash/clothing/head_icons.dmi'
