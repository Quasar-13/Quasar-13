// Names
GLOBAL_LIST_INIT(russian_names, world.file2list("ModularBungalow/tegu_beefmen/strings/tegu_russian.txt")) // Backtracked from names.dm
GLOBAL_LIST_INIT(experiment_names, world.file2list("ModularBungalow/tegu_beefmen/strings/tegu_experiment.txt")) // Backtracked from names.dm
GLOBAL_LIST_INIT(beefman_names, world.file2list("ModularBungalow/tegu_beefmen/strings/tegu_beefman.txt")) // Backtracked from names.dm
