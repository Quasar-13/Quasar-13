...
/datum/species/beefman
	...
	deathsound = 'ModularBungalow/beefmen/sounds/beef_die.ogg'
	attack_sound = 'ModularBungalow/beefmen/sounds/beef_hit.ogg'
	special_step_sounds = list('ModularBungalow/beefmen/sounds/footstep_splat1.ogg','ModularBungalow/beefmen/sounds/footstep_splat2.ogg','ModularBungalow/beefmen/sounds/footstep_splat3.ogg','ModularBungalow/beefmen/sounds/footstep_splat4.ogg')
	grab_sound = 'ModularBungalow/beefmen/sounds/beef_grab.ogg'
...
//			newSash = new /obj/item/clothing/under/bodysash/security()
		...
		if("Pharmacist")
			newSash = new /obj/item/clothing/under/bodysash/pharmacist()
		if("Virologist")
...
/datum/species/beefman/disarm(mob/living/carbon/human/user, mob/living/carbon/human/target, datum/martial_art/attacker_style)
	...
	if (user == target)
		...
		if ((target_zone in allowedList) && affecting)
			...
			playsound(get_turf(user), 'ModularBungalow/beefmen/sounds/beef_hit.ogg', 40, 1)
		...
		if ((target_zone in allowedList))
			...
			spawn(1)
				if (do_mob(user,H))
					...
					newBP.attach_limb(H)
					newBP.give_meat(H, I)
					playsound(get_turf(H), 'ModularBungalow/beefmen/sounds/beef_grab.ogg', 50, 1)
...
/obj/item/bodypart/head/beef
	icon = 'ModularBungalow/beefmen/icons/mob/beefman_bodyparts.dmi'
	icon_greyscale = 'ModularBungalow/beefmen/icons/mob/beefman_bodyparts.dmi'
	icon_greyscale_robotic = 'ModularBungalow/beefmen/icons/mob/beefman_bodyparts_robotic.dmi'
