...
*/
		...
		// Remember this Portal...it's gonna get checked for deletion. //better yet remove beefmen i hate this code so much
...
/obj/effect/hallucination/simple/phobetor
	...
	image_icon = 'ModularBungalow/beefmen/icons/phobetor_tear.dmi'
