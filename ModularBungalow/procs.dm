...
/client/proc/returncreditsmusic() // TEGUSTATION
	if (prob(15))
		return 'ModularBungalow/zbungalowsounds/Uhoh_Stinky.ogg'
	if (prob(5))
		return 'ModularBungalow/zbungalowsounds/Tegu_Piano_Old.ogg'
	return 'ModularBungalow/zbungalowsounds/Tegu_Piano.ogg'
