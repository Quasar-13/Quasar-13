...
/obj/item/xenoarch/strange_rock/examine(mob/user)
	. = ..()
	if(scanned == TRUE)
		. user.visible_message(user, "This item has been scanned. Max Depth: [max_depth] cm. Safe Depth: [safe_depth] cm.")
	if(measured == TRUE)
		. user.visible_message(user, "This item has been measured. Dug Depth: [dug_depth].")
