...
/obj/item/clothing/suit/neocoat/trench/cmo
	name = "senior medical officer's military labcoat"
	desc = "A Howie-style labcoat for military use. Comes in baby blue for the Senior Medical Officer."
	icon_state = "labcoat_cmo_long"

//Pharmacist
/obj/item/clothing/suit/neocoat/trench/pharm
	name = "pharmacist's military labcoat"
	desc = "A Howie-style labcoat for military use. Comes in bright pharmacist orange"
	icon_state = "labcoat_chem_long"

//Viro
/obj/item/clothing/suit/neocoat/trench/viro
	name = "virologist's military labcoat"
	desc = "A Howie-style labcoat for military use. Comes in virologist green. Hazard resistant."
	icon_state = "labcoat_viro_long"

//Geneticist
/obj/item/clothing/suit/neocoat/trench/gene
	name = "geneticist's military labcoat"
	desc = "A Howie-style labcoat for military use. Comes in geneticist blue."
	icon_state = "labcoat_viro_long"

//Robo
/obj/item/clothing/suit/neocoat/trench/robo
	name = "roboticist's white military labcoat"
	desc = "A Howie-style labcoat for military use. Comes in white with black and red accents for the roboticists."
...
/obj/item/clothing/suit/neocoat/trench/sci
	name = "scientist's military labcoat"
	desc = "A Howie-style labcoat for military use. Comes in research purple."
	icon_state = "labcoat_sci_long"

//Brig Doctor
/obj/item/clothing/suit/neocoat/trench/brigdoc
	name = "brig physicians's military labcoat"
	desc = "A Howie-style labcoat for military use. Comes in security red"
