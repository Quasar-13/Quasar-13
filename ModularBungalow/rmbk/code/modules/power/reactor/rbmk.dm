...
/obj/machinery/atmospherics/components/trinary/nuclear_reactor
	...
	icon = 'ModularBungalow/legacy_icons/reactor/rbmk.dmi'
...
/obj/machinery/atmospherics/components/trinary/nuclear_reactor/proc/handle_alerts()
	...
	if(warning)
		...
		relay('ModularBungalow/zbungalowsounds/rmbk/alarm.ogg', null, loop=TRUE, channel = CHANNEL_REACTOR_ALERT)
		set_light(0)
...
/obj/machinery/atmospherics/components/trinary/nuclear_reactor/proc/meltdown()
	...
	relay('ModularBungalow/zbungalowsounds/rmbk/meltdown.ogg', "<span class='userdanger'>You hear a horrible metallic hissing.</span>")
	stop_relay(CHANNEL_REACTOR_ALERT)
...
/obj/machinery/atmospherics/components/trinary/nuclear_reactor/proc/start_up()
	...
	desired_k = 1
	set_light(10)
	var/startup_sound = pick('ModularBungalow/zbungalowsounds/rmbk/startup.ogg', 'ModularBungalow/zbungalowsounds/rmbk/startup2.ogg')
...
/obj/item/fuel_rod
	...
	icon = 'ModularBungalow/legacy_icons/reactor/control_rod.dmi'
...
/obj/machinery/computer/reactor
	...
	desc = "Scream"
	icon = 'ModularBungalow/legacy_icons/reactor/computer.dmi'
	icon_state = "oldcomp"
	icon_screen = "library"
	icon_keyboard = null
...
/obj/machinery/computer/reactor/fuel_rods/attack_hand(mob/living/user)
	...
	if(!fuel_rod)
		return
	playsound(src, pick('ModularBungalow/zbungalowsounds/rmbk/switch.ogg','ModularBungalow/zbungalowsounds/rmbk/switch2.ogg','ModularBungalow/zbungalowsounds/rmbk/switch3.ogg'), 100, FALSE)
	playsound(reactor, 'ModularBungalow/zbungalowsounds/rmbk/crane_1.wav', 100, FALSE)
...
/obj/machinery/computer/reactor/pump/attack_hand(mob/living/user)
	...
	if(!is_operational)
		return FALSE
	playsound(loc, pick('ModularBungalow/zbungalowsounds/rmbk/switch.ogg','ModularBungalow/zbungalowsounds/rmbk/switch2.ogg','ModularBungalow/zbungalowsounds/rmbk/switch3.ogg'), 100, FALSE)
...
/obj/effect/decal/nuclear_waste
	...
	icon = 'ModularBungalow/legacy_icons/reactor/reactor_parts.dmi'
...
/datum/weather/nuclear_fallout
	...
	weather_sound = 'ModularBungalow/zbungalowsounds/rmbk/falloutwind.ogg'
	end_duration = 100
	area_type = /area
...
/obj/item/sealant
	...
	icon = 'ModularBungalow/legacy_icons/reactor/inflatable.dmi'
	icon_state = "sealant"
	w_class = 1
