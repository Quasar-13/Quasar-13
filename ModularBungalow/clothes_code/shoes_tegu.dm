...
/obj/item/clothing/shoes/laceup/digitigrade
	...
	tegu_item = TRUE
	icon = 'ModularBungalow/legacy_icons/shoes_tegu.dmi'
	icon_state = "digi_laceups"
	worn_icon = 'ModularBungalow/legacy_icons/feet_tegu.dmi'
...
//	alternate_worn_icon = 'ModularBungalow/legacy_icons/feet_tegu.dmi'
