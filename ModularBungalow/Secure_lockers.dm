...
/obj/structure/closet/secure_closet/hop_galaxy/PopulateContents()
	...
	new /obj/item/clothing/under/rank/command/head_of_personnel/freelancer(src)
	new /obj/item/clothing/under/rank/command/head_of_personnel/freelancer/skirt(src)
	new /obj/item/clothing/head/hopcap/freelancer(src)
