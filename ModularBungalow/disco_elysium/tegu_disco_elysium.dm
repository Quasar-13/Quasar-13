/obj/item/clothing/suit/det_suit/disco
	...
	worn_icon = 'ModularBungalow/legacy_icons/Surreal_stuff/disco_elysium_worn.dmi'
	icon = 'ModularBungalow/legacy_icons/Surreal_stuff/disco_elysium.dmi'
	icon_state = "jamrock_blazer"
	inhand_icon_state = "jamrock_blazer_held"
	lefthand_file = 'ModularBungalow/legacy_icons/Surreal_stuff/disco_elysium_inhand_left.dmi'
	righthand_file = 'ModularBungalow/legacy_icons/Surreal_stuff/disco_elysium_inhand_right.dmi'
