	...
	if(proximity_flag && ishuman(target))
		if(user != target)
			if(uses > 0 && audio_cd < world.time)
				...
				playsound(src, 'ModularBungalow/zbungalowsounds/apostle/antagonist/whisper.ogg', 50, 1)
...
/obj/item/clothing/suit/armor/apostle
	...
	worn_icon = 'ModularBungalow/legacy_icons/teguclothing_worn.dmi'
...
/obj/item/nullrod/scythe/apostle
	...
	hitsound = 'ModularBungalow/zbungalowsounds/apostle/antagonist/scythe.ogg'
	force = 34
...
/obj/item/nullrod/scythe/apostle/guardian/attack_self(mob/living/carbon/user)
	...
	user.emote("spin")
	user.emote("flip")
	playsound(src, 'ModularBungalow/zbungalowsounds/apostle/antagonist/scythe_spell.ogg', 150, 1)
...
/obj/item/nullrod/scythe/apostle/guardian/light/attack_hand(mob/living/user)
	if(!bound && !(faction_needed in user.faction))
		...
		SEND_SOUND(user, 'ModularBungalow/zbungalowsounds/apostle/mob/apostle_bell.ogg')
...
/obj/item/gun/magic/staff/apostle/process_fire(atom/target, mob/living/user, message = TRUE, params = null, zone_override = "", bonus_spread = 0)
	...
	playsound(src, 'ModularBungalow/zbungalowsounds/apostle/antagonist/staff_charge.ogg', 100, 1)
...
/obj/item/nullrod/spear/apostle
	...
	hitsound = 'ModularBungalow/zbungalowsounds/apostle/antagonist/spear.ogg'
...
/obj/item/nullrod/spear/apostle/attack_self(mob/living/carbon/user)
	...
	playsound(src, 'ModularBungalow/zbungalowsounds/apostle/antagonist/spear_charge.ogg', 100, 1)
	if(!do_after(user, 36))
		return
	recharge_time = (world.time + recharge_time_base) // The real cooldown
	user.forceMove(final_T)
	playsound(src, 'ModularBungalow/zbungalowsounds/apostle/antagonist/spear_dash.ogg', 100, 1)
