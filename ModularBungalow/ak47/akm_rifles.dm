...
/obj/item/gun/ballistic/automatic/ak47
	...
	icon = 'ModularBungalow/legacy_icons/48x32_guns.dmi'
	icon_state = "ak47"
	base_pixel_x = -8
	fire_sound = 'ModularBungalow/zbungalowsounds/weapons/guns/ak47.ogg'
	burst_size = 1
	actions_types = list()
	mag_display = TRUE
...
/obj/item/gun/ballistic/automatic/aks74u
	...
	icon = 'ModularBungalow/legacy_icons/48x32_guns.dmi'
	icon_state = "aks74u"
	fire_sound = 'ModularBungalow/zbungalowsounds/weapons/guns/ak47.ogg' // Temporary
	burst_size = 1
	actions_types = list()
	mag_display = TRUE
	weapon_weight = WEAPON_MEDIUM
...
/obj/item/ammo_box/magazine/ak47
	...
	icon = 'ModularBungalow/legacy_icons/magazines.dmi'
