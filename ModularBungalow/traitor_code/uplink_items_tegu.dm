...
/obj/item/toy/balloon/syndicate/gold
	...
	random_color = FALSE
	icon = 'ModularBungalow/legacy_icons/phoenix_nest/balloon.dmi'
	icon_state = "syndballoongold"
	inhand_icon_state = "syndballoongold"
	lefthand_file = 'ModularBungalow/legacy_icons/phoenix_nest/balloons_lefthand.dmi'
	righthand_file = 'ModularBungalow/legacy_icons/phoenix_nest/balloons_righthand.dmi'
