...
/obj/item/gun/ballistic/shotgun/doublebarrel/stopgap
	name = "KT-45 'Stop Gap'"
	desc =  "A small four-barrel shotgun, normally used by medics or some other heavy assault unit. this makes it a rivaling competitor to the taurus judge in versatility, typically fire .357 and .44 this one is modified to fire shotgun shells, developed very late into the occult war"
	icon_state = "stopgap"
	w_class = WEIGHT_CLASS_SMALL
