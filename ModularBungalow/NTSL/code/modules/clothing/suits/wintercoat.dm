...
/obj/item/clothing/suit/hooded/wintercoat/engineering/tcomms
	...
	icon = 'ModularBungalow/ntsl/icons/obj/clothing/suits/wintercoat.dmi'
	worn_icon = 'ModularBungalow/ntsl/icons/mob/clothing/suits/wintercoat.dmi'
...
/obj/item/clothing/head/hooded/winterhood/engineering/tcomms
	...
	icon = 'ModularBungalow/ntsl/icons/obj/clothing/head/winterhood.dmi'
	worn_icon = 'ModularBungalow/ntsl/icons/mob/clothing/head/winterhood.dmi'
