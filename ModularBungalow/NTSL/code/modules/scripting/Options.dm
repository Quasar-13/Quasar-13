...
/n_scriptOptions/nS_Options
	...
	* associated values are <nS_Keyword> types of which the <n_Keyword.Parse()> proc will be called.
	...
	var/list/binary_operators = list(
		...
		"&=" = /node/expression/operator/binary/Assign/BitwiseAnd, \
		"|=" = /node/expression/operator/binary/Assign/BitwiseOr, \
		"`=" = /node/expression/operator/binary/Assign/BitwiseXor, \
		"+=" = /node/expression/operator/binary/Assign/Add, \
		"-=" = /node/expression/operator/binary/Assign/Subtract, \
		"*=" = /node/expression/operator/binary/Assign/Multiply, \
		"/=" = /node/expression/operator/binary/Assign/Divide, \
