/mob/living/simple_animal/hostile/megafauna/claw
	...
	attack_sound = 'ModularBungalow/zbungalowsounds/claw/attack.ogg'
	icon_state = "claw"
	icon_living = "claw"
	icon = 'ModularBungalow/legacy_icons/tegumobs.dmi'
...
/obj/effect/target_field
	...
	icon = 'ModularBungalow/legacy_icons/tegu_effects.dmi'
...
/mob/living/simple_animal/hostile/megafauna/claw/proc/eviscerate(mob/living/carbon/human/target)
	...
	uhoh.orbit(target, 0)
	playsound(target, 'ModularBungalow/zbungalowsounds/claw/eviscerate1.ogg', 100, 1)
	playsound(src, 'ModularBungalow/zbungalowsounds/claw/eviscerate1.ogg', 1, 1)
...
/mob/living/simple_animal/hostile/megafauna/claw/proc/eviscerate2(mob/living/carbon/human/target, obj/effect/eff)
	if(prob(2) || target.z != z || !target.loc.AllowClick() || !target) // Be happy, mortal. Did you just hide in a locker?
		...
		playsound(src.loc, 'ModularBungalow/zbungalowsounds/claw/error.ogg', 50, 1)
		qdel(eff)
		return
	...
	forceMove(tp_loc)
	qdel(eff)
	playsound(target, 'ModularBungalow/zbungalowsounds/claw/eviscerate2.ogg', 100, 1)
...
/mob/living/simple_animal/hostile/megafauna/claw/proc/swift_dash(target, distance, wait_time)
	...
	playsound(src, 'ModularBungalow/zbungalowsounds/claw/prepare.ogg', 100, 1)
...
/mob/living/simple_animal/hostile/megafauna/claw/proc/swift_dash2(move_dir, times_ran, distance_run)
	...
	forceMove(T)
	playsound(src,'ModularBungalow/zbungalowsounds/claw/move.ogg', 50, 1)
