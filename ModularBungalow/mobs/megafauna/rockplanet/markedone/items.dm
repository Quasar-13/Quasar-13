...
/obj/item/claymore/agateram //it just works
	...
	icon = 'ModularBungalow/mobs/megafauna/rockplanet/markedone/blade.dmi'
	icon_state = "demonsword"
	inhand_icon_state = "demonsword"
	lefthand_file = 'ModularBungalow/mobs/megafauna/rockplanet/markedone/bladehandsleft.dmi'
	righthand_file = 'ModularBungalow/mobs/megafauna/rockplanet/markedone/bladehandsright.dmi'
