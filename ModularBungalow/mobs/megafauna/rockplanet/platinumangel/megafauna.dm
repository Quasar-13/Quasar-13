/mob/living/simple_animal/hostile/megafauna/platinumangel
	name = "platinum angel"
...
/mob/living/simple_animal/hostile/megafauna/platinumangel/Initialize()
	. = ..()
	miner_saw = new(src)
...
/mob/living/simple_animal/hostile/megafauna/platinumangel/OpenFire()
	if(client)
...
/mob/living/simple_animal/hostile/megafauna/platinumangel/death()
	. = ..()
	if(.)
		new /obj/effect/temp_visual/dir_setting/platinumangel(loc, dir)

/mob/living/simple_animal/hostile/megafauna/platinumangel/Move(atom/newloc)
	if(dashing || (newloc && newloc.z == z && (islava(newloc) || ischasm(newloc)))) //we're not stupid!
		return FALSE
	return ..()

/mob/living/simple_animal/hostile/megafauna/platinumangel/ex_act(severity, target)
	if(dash())
		return
	return ..()

/mob/living/simple_animal/hostile/megafauna/platinumangel/MeleeAction(patience = TRUE)
	transform_stop_attack = FALSE
	return ..()

/mob/living/simple_animal/hostile/megafauna/platinumangel/AttackingTarget()
	if(client)
		transform_stop_attack = FALSE
...
/mob/living/simple_animal/hostile/megafauna/platinumangel/do_attack_animation(atom/A, visual_effect_icon, obj/item/used_item, no_effect)
	if(!used_item && !isturf(A))
		used_item = miner_saw
	..()

/mob/living/simple_animal/hostile/megafauna/platinumangel/GiveTarget(new_target)
	var/targets_the_same = (new_target == target)
	. = ..()
	if(. && target && !targets_the_same)
		wander = TRUE

/mob/living/simple_animal/hostile/megafauna/platinumangel/proc/dash_attack()
...
/mob/living/simple_animal/hostile/megafauna/platinumangel/proc/dash(atom/dash_target)
...
/mob/living/simple_animal/hostile/megafauna/platinumangel/proc/transform_weapon()
...
/obj/effect/temp_visual/dir_setting/platinumangel
	icon_state = "platinumangel"
	duration = 15

/obj/effect/temp_visual/dir_setting/platinumangel/Initialize(mapload, set_dir)
	. = ..()
	INVOKE_ASYNC(src, .proc/fade_out)

/obj/effect/temp_visual/dir_setting/platinumangel/proc/fade_out()
	var/matrix/M = new
	M.Turn(pick(90, 270))
	var/final_dir = dir
...
/mob/living/simple_animal/hostile/megafauna/platinumangel/guidance
	guidance = TRUE

/mob/living/simple_animal/hostile/megafauna/platinumangel/hunter/AttackingTarget()
	. = ..()
	if(. && prob(12))
