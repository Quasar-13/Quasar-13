...
/mob/living/simple_animal/hostile/megafauna/sif
	...
	attack_sound = 'ModularBungalow/mobs/megafauna/tomb/sif/sound/sif_slash.ogg'
	icon_state = "Great_Brown_Wolf"
	icon_living = "Great_Brown_Wolf"
	icon_dead = ""
	friendly_verb_continuous = "stares down"
	friendly_verb_simple = "stare down"
	icon = 'ModularBungalow/mobs/megafauna/tomb/sif/sif.dmi'
	...
	deathsound = 'ModularBungalow/mobs/megafauna/tomb/sif/sound/death_howl.ogg'
...
/obj/structure/sword/sif
	...
	max_integrity = 10000
	anchored = TRUE
	icon = 'ModularBungalow/mobs/megafauna/tomb/sif/sif_sword.dmi'
...
/mob/living/simple_animal/hostile/megafauna/sif/proc/angered()
	...
	playsound(src, 'ModularBungalow/mobs/megafauna/tomb/sif/sound/howl.ogg', 100, 1)
			...
			if(isturf(src.loc) || isobj(src.loc) && src.loc.density)
				...
				for(var/mob/living/LM in view(1, src))
					if(!(LM in hit_things))
						LM.Stun(30, TRUE)
						hit_things += LM
				playsound(src, pick('ModularBungalow/mobs/megafauna/tomb/sif/sound/whoosh1.ogg', 'ModularBungalow/mobs/megafauna/tomb/sif/sound/whoosh2.ogg', 'ModularBungalow/mobs/megafauna/tomb/sif/sound/whoosh3.ogg'), 300, 1)
				playsound(src, 'ModularBungalow/mobs/megafauna/tomb/sif/sound/blade_spin.ogg', 400, 1)
				if(angered)
					src.speed = 6
					src.move_to_delay = 2
...
/mob/living/simple_animal/hostile/megafauna/sif/Bump(atom/A)
	if(charging == TRUE)
		...
		if(isliving(A))
			...
			playsound(get_turf(L), 'ModularBungalow/mobs/megafauna/tomb/sif/sound/sif_stomp.ogg', 400, 1)
			shake_camera(L, 4, 3)
