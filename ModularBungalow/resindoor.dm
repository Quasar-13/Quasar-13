/obj/structure/mineral_door/resin
	name = "resin door"
	icon = 'ModularBungalow/legacy_icons/xenodoors.dmi'
	icon_state = "resin"
	CanAtmosPass = ATMOS_PASS_NO
	openSound = 'ModularBungalow/zbungalowsounds/alien_resin_move1.ogg'
	closeSound = 'ModularBungalow/zbungalowsounds/alien_resin_move1.ogg'
