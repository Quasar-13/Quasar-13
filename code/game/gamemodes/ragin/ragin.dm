...
/datum/game_mode/ragin/pre_setup()
...
/datum/game_mode/ragin/post_setup()
	for(var/datum/mind/wizard in wizards)
		wizard.add_antag_datum(/datum/antagonist/wizard)
	return ..()

/datum/game_mode/ragin/generate_report()
...
/datum/game_mode/ragin/are_special_antags_dead()
...
/datum/game_mode/ragin/check_finished()
	. = ..()
	if(.)
		finished = TRUE
...
/datum/game_mode/ragin/set_round_result()
	..()
	if(finished)
		SSticker.mode_result = "loss - wizard killed"
		SSticker.news_report = WIZARD_KILLED

/datum/game_mode/ragin/special_report()
	if(finished)
