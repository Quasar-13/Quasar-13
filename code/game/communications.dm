...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_SOLGOV = FREQ_SOLGOV, // bunga-edit: solgov channel 2
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_SOLGOV]" = RADIO_CHANNEL_SOLGOV, // Bunga edit, solgov channel, im sorry egor i know you liked terragov better but i have sprites for solgov
