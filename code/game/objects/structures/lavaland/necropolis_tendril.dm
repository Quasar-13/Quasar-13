...
/obj/effect/collapse/Initialize()
	. = ..()
	emitted_light = new(loc)
	visible_message(span_boldannounce("The tendril writhes in fury as the earth around it begins to crack and break apart! Get back!</span>")
...
/obj/effect/collapse/proc/collapse()
	...
	visible_message(span_boldannounce("The tendril falls inward, the ground around it erupting into bubbling lava!</span>") //kirie edit, fuck chasms
