...
/obj/item/melee/transforming/energy/sword
	name = "energy sword"
	desc = "A horrifying combination of hardlight and. While Nanotrasen and the Syndicate both produce the so-called e-swords, they are visually and functionaly identical."
	icon_state = "sword"
