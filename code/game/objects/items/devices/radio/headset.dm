...
GLOBAL_LIST_INIT(channel_tokens, list(
	...
	RADIO_CHANNEL_TERRAGOV = RADIO_TOKEN_TERRAGOV, // Tegustation TerraGov edit
...
/obj/item/radio/headset/talk_into(mob/living/M, message, channel, list/spans, datum/language/language, list/message_mods, direct = TRUE) //BUNGALOW EDIT CHANGE - GUNPOINT
	if (!listening)
...
/obj/item/radio/headset/headset_sct
	name = "secretary's headset"
	desc = "A headset allowing the wearer to communicate with command, medbay, cargo, security and engineering. So, everything needed to keep the station afloat"
	icon_state = "com_headset"
	keyslot = new /obj/item/encryptionkey/headset_sct
...
/obj/item/radio/headset/heads/qm
	...
	desc = "The headset of the guy who loves to tell people to push around boxes"
	icon_state = "com_headset"
