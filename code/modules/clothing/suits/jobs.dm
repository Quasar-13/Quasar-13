...
/obj/item/clothing/suit/captunic
	name = "captain's refractive parade tunic"
	desc = "Worn by a Captain to show their class. Woven from refractive fibres to stop lasers and energy blasts better."
	icon_state = "captunic"
	inhand_icon_state = "bio_suit"
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
	flags_inv = HIDEJUMPSUIT
	armor = list(MELEE = 35, BULLET = 25, LASER = 70, ENERGY = 70, BOMB = 25, BIO = 0, RAD = 0, FIRE = 100, ACID = 90, WOUND = 20)
...
/obj/item/clothing/suit/security/officer
	...
	desc = "This jacket is for those special occasions when a security officer wants the NT ceritified DRIP."
