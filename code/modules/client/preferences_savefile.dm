...
/datum/preferences/proc/load_character(slot)
	...
	features["bee_wings"]	= sanitize_inlist(features["bee_wings"], GLOB.bee_wings_list, "Simple")
	features["tail_bee"]	= sanitize_inlist(features["tail_bee"], GLOB.bee_tails_list, "Simple")
...
/datum/preferences/proc/save_character()
	...
	WRITE_FILE(S["feature_bee_tail"]					,["tail_bee"])
	WRITE_FILE(S["feature_bee_wings"]					,["bee_wings"])
