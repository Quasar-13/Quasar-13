/datum/job/logistics_officer
	...
	access = list(ACCESS_SYNDICATE, ACCESS_SYNDICATE_OFFICER, ACCESS_SYNDICATE_COMMAND, ACCESS_ATMOSPHERICS, ACCESS_SYNDICATE_LOGISTICS)
	minimal_access = list(ACCESS_SYNDICATE, ACCESS_SYNDICATE_OFFICER, ACCESS_SYNDICATE_COMMAND, ACCESS_ATMOSPHERICS, ACCESS_SYNDICATE_LOGISTICS)
