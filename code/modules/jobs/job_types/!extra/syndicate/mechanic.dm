/datum/job/mechanic
	...
	access = list(ACCESS_SYNDICATE, ACCESS_ATMOSPHERICS, ACCESS_SYNDICATE_LOGISTICS)
	minimal_access = list(ACCESS_SYNDICATE, ACCESS_ATMOSPHERICS, ACCESS_SYNDICATE_LOGISTICS)
