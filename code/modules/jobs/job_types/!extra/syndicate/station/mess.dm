/datum/job/messtech
	...
	access = list(ACCESS_SYNDICATE, ACCESS_SYNDICATE_AUXILIARY, ACCESS_BARTENDER)
	minimal_access = list(ACCESS_SYNDICATE, ACCESS_SYNDICATE_AUXILIARY, ACCESS_BARTENDER)
