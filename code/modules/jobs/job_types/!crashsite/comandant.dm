/datum/job/commandant
	...
	access = list(ACCESS_SYNDICATE, ACCESS_SYNDICATE_SCIENCE, ACCESS_SYNDICATE_CARGO, ACCESS_SYNDICATE_BRIDGE, ACCESS_SYNDICATE_ARMORY, ACCESS_SYNDICATE_ENGINEERING, ACCESS_SYNDICATE_POLICE, ACCESS_SYNDICATE_OFFICER, ACCESS_SYNDICATE_LEADER, ACCESS_SYNDICATE_COMMAND, ACCESS_SYNDICATE_COMMANDANT, ACCESS_SYNDICATE_POLICE, ACCESS_HEADS)
	minimal_access = list(ACCESS_SYNDICATE, ACCESS_SYNDICATE_SCIENCE, ACCESS_SYNDICATE_CARGO, ACCESS_SYNDICATE_BRIDGE, ACCESS_SYNDICATE_ARMORY, ACCESS_SYNDICATE_ENGINEERING, ACCESS_SYNDICATE_POLICE, ACCESS_SYNDICATE_OFFICER, ACCESS_SYNDICATE_LEADER, ACCESS_SYNDICATE_COMMAND, ACCESS_SYNDICATE_COMMANDANT, ACCESS_SYNDICATE_POLICE, ACCESS_HEADS)
