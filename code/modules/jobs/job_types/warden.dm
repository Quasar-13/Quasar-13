/datum/job/warden
	...
	mapexclude = list("naval", "goonlite")
...
/datum/outfit/job/warden/freelancer
	name = "Warden (Freelancer)"

	head = /obj/item/clothing/head/warden
	uniform = /obj/item/clothing/under/rank/security/warden/freelancer
	suit = /obj/item/clothing/suit/armor/vest/warden/alt/freelancer
