/datum/job/blueshield
	...
	access = list(ACCESS_SECURITY, ACCESS_HOS, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_COURT, ACCESS_WEAPONS, ACCESS_MECH_SECURITY,
	...
	minimal_access = list(ACCESS_SECURITY, ACCESS_HOS, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_COURT, ACCESS_WEAPONS, ACCESS_MECH_SECURITY,
					ACCESS_MORGUE, ACCESS_MAINT_TUNNELS,ACCESS_AUX_BASE,
					ACCESS_RESEARCH, ACCESS_ENGINE, ACCESS_MINING, ACCESS_MEDICAL, ACCESS_CONSTRUCTION, ACCESS_MAILSORTING, ACCESS_EVA, ACCESS_TELEPORTER,
					ACCESS_HEADS, ACCESS_MAINT_TUNNELS, ACCESS_MINERAL_STOREROOM)
