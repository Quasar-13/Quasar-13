...
/mob/living/carbon/human/proc/equipOutfit(outfit, visualsOnly = FALSE, client/preference_source = null)//bungalow edit - alt job titles
	...
	return O.equip(src, visualsOnly, preference_source)//bungalow edit - alt job titled
