...
/obj/item/clothing/suit/hooded/explorer
	...
	armor = list(MELEE = 30, BULLET = 10, LASER = 10, ENERGY = 0, BOMB = 50, BIO = 100, RAD = 50, FIRE = 50, ACID = 50)
...
/obj/item/clothing/head/hooded/explorer
	...
	max_heat_protection_temperature = SPACE_SUIT_MAX_TEMP_PROTECT
	armor = list(MELEE = 30, BULLET = 10, LASER = 10, ENERGY = 0, BOMB = 50, BIO = 100, RAD = 50, FIRE = 50, ACID = 50, WOUND = 10)
	resistance_flags = FIRE_PROOF
...
/obj/item/clothing/mask/gas/explorer
	...
	armor = list(MELEE = 10, BULLET = 5, LASER = 5, ENERGY = 0, BOMB = 0, BIO = 50, RAD = 0, FIRE = 20, ACID = 40, WOUND = 5)
	resistance_flags = FIRE_PROOF
...
/obj/item/clothing/suit/space/hostile_environment
	...
	slowdown = 0
	armor = list(MELEE = 70, BULLET = 20, LASER = 20, ENERGY = 15, BOMB = 70, BIO = 100, RAD = 100, FIRE = 100, ACID = 100)
	allowed = list(/obj/item/flashlight, /obj/item/tank/internals, /obj/item/resonator, /obj/item/mining_scanner, /obj/item/t_scanner/adv_mining_scanner, /obj/item/gun/energy/kinetic_accelerator, /obj/item/pickaxe)
