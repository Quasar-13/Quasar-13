...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("10 Marker Beacons",			/obj/item/stack/marker_beacon/ten,									50),
		...
		new /datum/data/mining_equipment("Digitigrate Combat Boots",	/obj/item/clothing/shoes/digicombat,	 							300), // Tegustation digitigrade edit: Miners can buy combat boots!
		...
		new /datum/data/mining_equipment("Resonator",					/obj/item/resonator,												500),
