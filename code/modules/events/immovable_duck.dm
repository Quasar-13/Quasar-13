/datum/round_event_control/immovable_duck/duck
	name = "Immovable Duck"
	typepath = /datum/round_event/immovable_duck/duck
	weight = 2
	max_occurrences = 1

/datum/round_event_control/immovable_duck/duck/admin_setup()
...
/datum/round_event/immovable_duck/duck/announce(fake)
	priority_announce("What the duck was that?!", "General Alert")

/datum/round_event/immovable_duck/duck/start()
	var/datum/round_event_control/immovable_duck/duck/C = control
...
/obj/effect/immovablerod/duck/Collide(atom/clong)
	if(prob(90))
