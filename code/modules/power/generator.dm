/obj/machinery/power/generator
	...
	icon = 'ModularBungalow/zbungalowicons/machinery/thermoelectric.dmi'
...
//	var/datum/gas_mixture/hot_circ_air1 = hot_circ.airs[1] //outlet hot
	...
	data["cold_circ_temp"] = round(cold_circ_air2.temperature, 0.1)
	data["cold_circ_pressure"] = round(cold_circ_air2.return_pressure(), 0.1)
	data["hot_circ_temp"] = round(hot_circ_air2.temperature, 0.1)
