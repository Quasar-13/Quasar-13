...
/obj/item/reagent_containers/hypospray/medipen/survival
	...
	list_reagents = list( /datum/reagent/medicine/epinephrine = 8, /datum/reagent/medicine/oxandrolone = 8, /datum/reagent/medicine/sal_acid = 8,/datum/reagent/medicine/leporazine = 6)
