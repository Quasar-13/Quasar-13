	...
	switch(stage)
		if(1)
			if(DT_PROB(2.5, delta_time))
				to_chat(affected_mob, pick("<span class = 'warning'>You feel lightheaded.</span>", "<span class = 'warning'>You feel lethargic.</span>"))
		if(2)
			...
			if(DT_PROB(2.5, delta_time))
				to_chat(affected_mob, pick("<span class = 'warning'>You feel pain shoot down your legs!</span>", "<span class = 'warning'>You feel like you are going to pass out at any moment.</span>", "<span class = 'warning'>You feel really dizzy.</span>"))
