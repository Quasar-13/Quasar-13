/datum/map_generator/cave_generator/icemoon
	open_turf_types =  list(/turf/open/floor/plating/asteroid/snow/icemoon = 94, /turf/open/floor/plating/ice/icemoon = 5, /turf/open/lava/plasma = 1)
	closed_turf_types =  list(/turf/closed/mineral/random/snow = 1)


	feature_spawn_list = list(/obj/structure/geyser/random = 1)
	mob_spawn_list = list(/mob/living/simple_animal/hostile/asteroid/wolf = 50, /obj/structure/spawner/ice_moon = 3, /obj/structure/spawner/ice_moon/demonic_portal = 1, \
