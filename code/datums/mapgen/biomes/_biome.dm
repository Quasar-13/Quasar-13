...
/datum/biome/mudlands
	...
	flora_density = 3
	fauna_types = list(/mob/living/simple_animal/hostile/jungle/mook = 60, /mob/living/simple_animal/hostile/jungle/mega_arachnid = 2, /mob/living/simple_animal/hostile/jungle/leaper = 1)
	fauna_density = 0.1
