/atom/movable/screen/infection/InfectionSporeHelp
	icon_state = "help_hud"
	name = "Infection Help"
	desc = "Help on playing the infection!"

/atom/movable/screen/infection/InfectionSporeHelp/Click()
	var/mob/living/simple_animal/hostile/infection/infectionspore/sentient/I = usr
	I.infection_help()

/atom/movable/screen/infection/Refund
...
/atom/movable/screen/infection/Refund/Click()
	var/mob/living/simple_animal/hostile/infection/infectionspore/sentient/I = usr
	I.refund_upgrades()

/atom/movable/screen/infection/EvolveSpore
	icon_state = "upgrade_hud"
	name = "Evolution"
	desc = "Purchase traits that make you stronger."

/atom/movable/screen/infection/EvolveSpore/Click()
	var/mob/living/simple_animal/hostile/infection/infectionspore/sentient/I = usr
	I.evolve_menu()

/atom/movable/screen/infection/Respawn
	icon_state = "core_hud"
	name = "Respawn"
	desc = "Lets you come back from the dead once you have finished reforming."

/atom/movable/screen/infection/Respawn/Click()
	var/mob/living/simple_animal/hostile/infection/infectionspore/sentient/I = usr
	I.do_spawn()
...
/datum/hud/infection_spore/New(mob/owner)
	...
	using = new /atom/movable/screen/infection/InfectionSporeHelp()
	using.screen_loc = ui_back
	static_inventory += using

	using = new /atom/movable/screen/infection/Refund()
	using.screen_loc = ui_hand_position(2)
	static_inventory += using

	using = new /atom/movable/screen/infection/EvolveSpore()
	using.screen_loc = ui_hand_position(1)
	static_inventory += using

	using = new /atom/movable/screen/infection/Respawn()
