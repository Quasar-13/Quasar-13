/obj/item/clothing/under/bodysash
	...
	icon = 'ModularTegustation/tegu_beefmen/icons/mob/clothing/beefclothing.dmi' // item icon
	worn_icon =  'ModularTegustation/tegu_beefmen/icons/mob/clothing/beefclothing_worn.dmi' // mob worn icon
	icon_state = "assistant" // Inventory Icon
	body_parts_covered = CHEST // |GROIN|ARMS
	lefthand_file = 'ModularTegustation/tegu_beefmen/icons/mob/clothing/beefclothing_hold_left.dmi'
	righthand_file = 'ModularTegustation/tegu_beefmen/icons/mob/clothing/beefclothing_hold_right.dmi'
